...
| ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Color               | `M3` collection `54778:406` has 197 variables and 32 modes, including light, dark, contrast and named schemes.                                                                                         | Compose has 48 light/dark bindings, with four light disagreements against the kit. The kit/Web `Shadow` role fills the one missing scheme role; see [reconciliation](reconciliation.md). Contrast and named modes remain separately inventoried until Compose membership is resolved. Matched rendered scenarios are still needed.                                                                                                                       |
| Typography          | `Typescale` `55064:15508` has 90 variables; the export has 30 `M3/` text styles, 15 of them emphasized.                                                                                                | Compose supplies all 30 role metrics and override behavior. The kit's explicit Roboto fills the browser comparison-font gap. Forty-five Typescale font/weight variables are unresolved external aliases in the extraction; resolve them from style nodes or another explicit source before using those aliases.                                                                                                                                         |
...
| Spacing and density | No global variable or style is named spacing or density; five component sets explicitly mention density.                                                                                               | Resolve Compose component geometry first, measure the relevant kit nodes for gaps, and use [Material guidance](https://m3.material.io/styles/spacing/overview) only for remaining gaps. Do not infer a universal spacing scale.                                                                                                                                                                                                                      |
...
decisions. The next evidence pass must resolve external aliases and component
geometry and choose matched light/dark and responsive scenarios.
