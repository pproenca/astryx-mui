...
`src/material3SpatialSource.json` contain palette, color-role, typeface,
typescale, tracking, shape, motion, state, and component geometry
...
color, typography, shape, motion, state, and geometry value against the Sass result. Changes to this data should
