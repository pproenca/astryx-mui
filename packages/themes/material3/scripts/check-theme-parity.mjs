...
assert.equal(Object.keys(source.material3Theme.localTokens).length, 168);
...
try {
  ...
  console.log(
    `Chrome ${browser.version()}: 49 color roles in both modes, portable accent/type, 168 static local roles, and runtime/built values agree.`,
  );
} finally {
  await browser.close();
}
